"""CV Tailor Agent: reads CV, cover letter, and job description, then produces tailored versions."""
...
from ai_demo.core.document import read_pdf_tool, read_file_tool, write_file_tool
