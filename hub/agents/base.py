...
# Tell LiteLLM to silently drop unsupported params
...
class BaseAgent(ABC):
    """Abstract base agent using Strands with LiteLLM."""
    ...
    def _create_model(self) -> LiteLLMModel:
        ...
        if self.is_reasoning:
            ...
            logger.debug(
                "Reasoning model (%s) — dropped temperature, max_completion_tokens=%d",
